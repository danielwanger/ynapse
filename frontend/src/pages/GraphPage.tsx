...
export default function GraphPage() {
  ...
  return (
    <div className="page page-full" style={{ textAlign: "left" }}>
      <h1 style={{ textAlign: "left", marginBottom: "1rem" }}>Labelgraph</h1>
      <div className="graph-toggle" style={{ marginBottom: "1.2rem" }}>
